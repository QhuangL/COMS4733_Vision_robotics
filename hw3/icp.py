...
def mesh2pts(mesh_path, N, transform = None):
    """
...
def obj_mesh2pts(objID, point_num, transform = None):
    """
    :param objID:
    ...
    pts = mesh2pts(mesh_path=obj_filename, N=point_num, transform=transform)
    return pts
